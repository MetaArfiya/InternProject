...
class JobModel {
  ...
  // 🆕 Info tambahan untuk validasi UI
  final String? paymentStatus;
  final bool customerProofUploaded;
  ...
  JobModel({
    ...
    this.myRating,
    this.paymentStatus,
    this.customerProofUploaded = false,
  });
  ...
  JobModel copyWith({
    ...
    return JobModel(
      ...
      customerProofUploaded: customerProofUploaded ?? this.customerProofUploaded,
    );
  }
  ...
  factory JobModel.fromJson(Map<String, dynamic> json) {
    ...
    // ============================================================
    // PAYMENT (info tambahan)
    // ============================================================
    final String? paymentStatus = json['payment_status']?.toString();

    final bool customerProofUploaded =
        json['customer_proof_uploaded'] == true ||
        json['customer_proof_uploaded'] == 1 ||
        json['customer_proof_uploaded']?.toString().toLowerCase() == 'true';
    ...
    // BUKTI PEKERJAAN
    // ============================================================
    final completionPhotoUrl =
        _buildProofUrl(json['completion_photo_url']?.toString());
    final completionStatus = json['completion_status']?.toString();
    final completionAdminNote = json['completion_admin_note']?.toString();
    final completionSubmittedAt = json['completion_submitted_at'] != null
        ? DateTime.tryParse(json['completion_submitted_at'].toString())
    ...
    return JobModel(
      ...
      customerProofUploaded: customerProofUploaded,
    );
  }
